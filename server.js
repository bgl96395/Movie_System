...
const review_cartoon = require("./routes/review_cartoons_route")
const review_channel = require("./routes/review_channels_route")
...
app.use(review_cartoon)
app.use(review_channel)
