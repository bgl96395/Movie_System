...
router.post("/api/movies",admin,movie_controller.create_movies)
router.put("/api/movies/:id",admin,movie_controller.update_movie)
router.delete("/api/movies/:id",admin,movie_controller.delete_movie)
