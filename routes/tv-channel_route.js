...
router.post("/api/tv-channel",admin,channel_controller.create_channel)
router.put("/api/tv-channel/:id",admin,channel_controller.update_channel)
router.delete("/api/tv-channel/:id",admin,channel_controller.delete_channel)
